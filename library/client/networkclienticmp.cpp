...
NetworkClientIcmp::NetworkClientIcmp(const std::string &host, const std::string &port): NetworkClientBase (host, port)
{
}
...
int NetworkClientIcmp::write(const uint8_t *buffer, std::size_t size)
{
    boost::system::error_code ec;
...
int NetworkClientIcmp::wait(std::chrono::steady_clock::duration timeout)
{
    boost::system::error_code ec;

    socket->async_wait(boost::asio::ip::icmp::socket::wait_read,
...
int NetworkClientIcmp::available()
{
    boost::system::error_code ec;
...
int NetworkClientIcmp::read_some(uint8_t *buffer, std::size_t size)
{
    boost::system::error_code ec;
...
int NetworkClientIcmp::read_some_wait(uint8_t *buffer, std::size_t size)
{
    boost::system::error_code ec;
...
int NetworkClientIcmp::read_exactly(uint8_t *buffer, std::size_t size, std::chrono::steady_clock::duration timeout)
{
    boost::system::error_code ec;
...
int NetworkClientIcmp::read_until(std::string &buffer, const std::string &delim, std::chrono::steady_clock::duration timeout)
{
    boost::system::error_code ec;
    std::chrono::steady_clock::time_point stop = std::chrono::steady_clock::now() + timeout;
    bool timedout = false;
...
bool NetworkClientIcmp::run_for(std::chrono::steady_clock::duration timeout)
{
    io_context->restart();
...
bool NetworkClientIcmp::run_until(const std::chrono::steady_clock::time_point &timepoint)
{
    io_context->restart();
