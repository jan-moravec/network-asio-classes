#ifndef NETWORKCLIENTUDP_H
#define NETWORKCLIENTUDP_H

#include <memory>
#include <boost/asio.hpp>
#include "networkclientbase.h"

class NetworkClientUdp: public NetworkClientBase
{
public:
    NetworkClientUdp(const std::string &host, const std::string &port);
...
protected:
    ...
    std::unique_ptr<boost::asio::ip::udp::resolver> resolver;
